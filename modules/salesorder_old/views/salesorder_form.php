                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" name="nmcustomer" id="nmcustomer" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" name="nmsalesman" id="nmsalesman" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="nilaippn" id="nilaippn"/>
                                </div>
                            </div>
                        </div>
                        <!--
    ...
    <div class="box-body">
        ...
        <table class="table table-bordered">
            ...
            <tr style="text-align: center;">
                    <th width="25%">
                        <select onchange="setitembarang()" id="item_brg_so" name="item_brg_so" class="form-control input-sm" style="width: 100%;" tabindex="-1" required>
                            <option value=""></option>
                            <?php

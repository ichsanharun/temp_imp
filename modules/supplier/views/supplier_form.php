            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_supplier','name'=>'frm_supplier','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group ">
                    <input type="hidden" id="id_supplier" name="id_supplier" value="<?php echo set_value('id_supplier', isset($data->id_supplier) ? $data->id_supplier : ''); ?>">
                        <?php  if(isset($data->id_supplier)){$type='edit';}?>
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" id="nm_supplier" name="nm_supplier" maxlength="255" value="<?php echo set_value('nm_supplier', isset($data->nm_supplier) ? $data->nm_supplier : ''); ?>" placeholder="Nama Supplier" required style="text-transform:uppercase">
                        </div>
                    </div>

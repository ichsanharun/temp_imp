        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <input <?php //echo $disabled?> type="checkbox" class="set_choose_do" name="set_choose_do" id="set_choose_do<?php echo $no?>" value="<?php echo $vso->no_so_pending?>" onclick="cekcus('<?php echo $vso->id_customer?>','<?php echo $no?>')">
                </td>
            </tr>
            <?php } ?>
            <?php } ?>
...
<script type="text/javascript">
  ...
  function getcustomer(){
        ...
        window.location.href = siteurl+"deliveryorder_2/createpending/"+idcus;
      }
  function proses_do(){
    var param = $('#cekcus').val();
    var uri3 = '<?php echo $this->uri->segment(3)?>';
    window.location.href = siteurl+"deliveryorder_2/prosesdopending/"+uri3+"?param="+param;
  }
	$(function() {
    	$("#example1").DataTable();
    	$("#form-area").hide();

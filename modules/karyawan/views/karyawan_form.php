            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_biodata','name'=>'frm_biodata','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" id="nik" name="nik" maxlength="15" value="<?php echo set_value('nik', isset($data->nik) ? $data->nik : ''); ?>" placeholder="Nomor Induk Karyawan" style="text-transform:uppercase">
                        </div>
                    </div>
                </div>

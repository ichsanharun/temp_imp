...
class Purchaserequest extends Admin_Controller {
    ...
    public function create()
    {
        ...
        $cabang = $this->Purchaserequest_model->get_data('1=1','cabang');
        $prtemp = $this->Purchaserequesttmp_model->join('barang_master','trans_pr_detail_tmp.id_barang = barang_master.id_barang','left')->find_all_by(array('trans_pr_detail_tmp.created_by'=>$session['id_user']));
    ...
    function saveheaderpr(){
        ...
        'kdcab' => $this->input->post('idcabang'),
    		...
    		'total_pr' => $this->input->post('totalpr'),
    		'created_on' => date('Y-m-d H:i:s'),
    		'created_by' => $session['id_user']
		);
		$this->db->trans_begin();

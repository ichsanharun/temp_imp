            ...
            <?= form_open_multipart($this->uri->uri_string(),array('id'=>'frm_barang','name'=>'frm_barang','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" id="harga" name="harga" onkeyup="this.value=this.value.replace(/[^0-9\.]/g,'');document.getElementById(this.id).value = formatCurrency(this.value);" value="<?php echo set_value('harga', isset($data->harga) ? $data->harga : ''); ?>" required>
                        </div>
                    </div>

        ...
        <!-- Biodata Mitra -->
            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_menus','name'=>'frm_menus','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group ">                    
                    ...
                    <label for="title" class="col-sm-2 control-label">Nama Menu <font size="4" color="red"><B>*</B></font></label>
                    <div class="col-sm-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" id="title" name="title" maxlength="45" value="<?php echo set_value('title', isset($data->title) ? $data->title : ''); ?>" placeholder="Nama menu" required>
                        </div>
                    </div>                                   
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
							...
							echo form_dropdown('parent_id',$datmenu, set_value('parent_id', isset($data->parent_id) ? $data->parent_id : 'selected'), array('id'=>'parent_id','class'=>'form-control parent_id'));											
							?>                         
                        </div>
                    </div>
                </div>
				<div class="form-group ">
					<label for="link" class="col-sm-2 control-label">Group Menu<font size="4" color="red"><B>*</B></font></label>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <div class="input-group-btn">
                            <a class="btn btn-info">
                            ...
                            <?php
							$datgroupmenu[0]	= 'Select An Option';						
							echo form_dropdown('group_menu',$datgroupmenu, set_value('group_menu', isset($data->group_menu) ? $data->group_menu : 'selected'), array('id'=>'group_menu','class'=>'form-control group_menu'));											
							?>                         
                        </div>
                    </div>

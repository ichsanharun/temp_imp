...
<div class="box box-default ">
    <div class="box-body">
        ...
        $pn = $grand-$dpp;
            ...
            <input type="hidden" name="hargajualbefdis" value="<?php echo ceil($harga*$qty_supply)?>">
            <input type="hidden" name="hargajualafterdis" value="<?php echo ceil($harga_setelah_diskon_promo*$qty_supply)?>">
            <input type="hidden" name="hargajualafterdistoko" value="<?php echo ceil($harga_setelah_diskon_toko*$qty_supply)?>">
            ...
            <input type="hidden" name="ppn" id="n_ppn" value="<?php echo ceil($pn)?>">
            <input type="hidden" name="hargajualtotal" id="n_grand" value="">

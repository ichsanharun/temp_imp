        ...
        <!-- Biodata Mitra -->
            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_cabang','name'=>'frm_cabang','role'=>'form','class'=>'form-horizontal')) ?>
                ...
                <div class="form-group ">
                    ...
                    <label for="no_do" class="col-sm-2 control-label">Number Delivery Order<font size="4" color="red"><B>*</B></font></label>
                    <div class="col-sm-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" id="no_do" name="no_do" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?php echo set_value('no_do', isset($data->no_do) ? $data->no_do : '0'); ?>" placeholder="No DO" required>
                        </div>
                    </div>

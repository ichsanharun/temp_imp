                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            <label for="idcabang" class="col-sm-5 control-label">Nama Cabang <font size="4" color="red"><B>*</B></font></label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <div class="input-group">
                                ...
                                <select id="idsupplier" name="idsupplier" class="form-control input-sm select2" style="width: 97%;" tabindex="-1" required onchange="getsupplier()">
                                  <option value=""></option>
                                  <?php
                ...
                foreach (@$itembarang as $data => $datas) {
                  ...
                  ++$noor; ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <input class="form-control input-sm" name="qty<?= $noor; ?>" id="qty<?= $noor; ?>" onkeyup="sum<?= $noor; ?>(); HitungTotal('<?php echo $noor; ?>')" value="0" <?=$dis?>/>
                      </td>
                      <td>
              ...
              <tfoot>
                  <tr>
                      <th class="text-right" colspan="13">
                          <a href="javascript:void(0)" class="btn btn-danger" onclick="kembali()">
                              <i class="fa fa-refresh"></i><b> Kembali</b>
                          </a>
                          <a href="javascript:void(0)" class="btn btn-primary" onclick="saveheaderpr()" >

                              ...
                              <div class="form-group ">
                                  ...
                                  <div class="col-sm-8">
                                      <div class="input-group">
                                          ...
                                          <input type="text" name="tglpr" id="tglpr" class="form-control input-sm datepicker" value="<?php echo $pr_hader->tgl_pr?>">
                                      </div>
                                  </div>
                              </div>
            ...
            <tbody id="dtazz">
              ...
              foreach (@$itembarang as $data => $datas) {
                  ...
                  <tr>
                      ...
                      <td>
                          <input name="qty<?= $noor; ?>" id="qty<?= $noor; ?>" onkeyup="sum<?= $noor; ?>(); HitungTotal('<?php echo $noor; ?>');this.value = this.value.match(/^-?\d*[.]?\d*$/)" value="<?= $qtyx; ?>" />
                      </td>
                      <td>
...
function HitungTotal(id)
{
   ...
   function saveheaderpr(){
                ...
                var formdata = $("#form-header-pr, #form-detail-pr").serialize();

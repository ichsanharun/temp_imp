...
<div class="box box-default ">
    <div class="box-body">
        ...
        if($this->uri->segment(3) != ""){
            $brg = $this->Purchaserequest_model->cek_data(array('id_barang'=>$this->uri->segment(3)),'barang_master');
        }
        ?>
        ...
        <table class="table table-bordered" width="100%">
            ...
            <tr>
                ...
                <td width="10%" class="text-right"><b><?php echo "QTY STOK : ".$qty_stok;?></b></td>
                <td width="13%"></td>
        ...
        <?php
            $colly = $this->Purchaserequest_model->get_data(array('id_barang' => $this->uri->segment(3)),'barang_koli');
            $mastah = $this->Purchaserequest_model->get_data(array('id_barang' => $this->uri->segment(3)),'barang_master');
        ?>
        <table class="table table-bordered" width="100%">
            <tr>
        ...
        <table id="prdetailitem" class="table table-bordered table-striped" width="100%">
            ...
            <tbody>
               ...
               <tr>
                   ...
                   <td class="text-right"><?php echo $vp->nm_supplier?></td>
                   <td>
                        <center>
...
<script type="text/javascript">
    ...
    function setitembarang(){
        ...
        window.location.href = siteurl+'purchaserequest/create/'+idbarang;
    }

...
<form id="form-header-pr"  method="post">
      ...
      <div class="tab-content">
          <div class="tab-pane active" id="pr">
              <div class="box box-primary">
                  ...
                  <input type="hidden" name="nm_supplier" value="<?= $pr_hader->nm_supplier ?>" />
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="box box-default ">
          ...
          <table id="TabelTransaksi" class="table table-bordered" width="100%">
            ...
            <tfoot>
              <tr>
                  ...
                  <td></td>
                  <td id="ttlCBMsub"><?= $total_cbmx ?></td>
                  <td></td>
                  <td id="skgs"><?= $total_khsx ?></td>
              </tr>
            </tfoot>
          </table>
      </div>
      ...
      <form id="tambahaan" method="post" style="display:none"-->
...
<br>
<form id="konfirmasi" method="post">
    <center>
        <div class="can-toggle can-toggle--size-large" style="left: 50%; margin-left: -100px;">
          <input name="konfirmasi_klik" onclick="javascript:toggle(this);" id="c" value="REVISI" type="checkbox">
          <label for="c">
            <div class="can-toggle__switch" data-checked="ACC" data-unchecked="REVISI"></div>
          </label>
        </div>
    </center>
    <br>
    <input type="hidden" id="revisi_pil" name="revisi_pil" value="REVISI" />
    <div class="nav-tabs-pr">
        <div class="tab-content">
            <div class="tab-pane active">
                <div class="box box-primary">
                    <div id="rev" style="display: block" >
                        <center><h3><b>REVISI</b></h3></center>
                        <textarea class="form-control" id="keterangan" name="keterangan_revisi"  placeholder="Keterangan" style="margin: 0px; height: 100px; width: 100%;"></textarea>
                    </div>
                    <div id="acc" style="display: none">
                        <input type="hidden" name="keterangan" value="Disetujui"/>
                        <center>
                            <h2>Apakah Anda yakin untuk menyetujui Purchase Request ini..?</h2>
                        </center>
                        <br />
                    </div>
                </div>
...
// Toggles the passed button from OFF to ON and vice-versa.
        function toggle(button) {
            switch (button.value) {
                case "ACC":
                    document.getElementById("revisi_pil").value = "REVISI";
                    document.getElementById( 'acc' ).style.display = 'none';
                    document.getElementById( 'rev' ).style.display = 'block';
                    button.value = "REVISI";
                    break;
                case "REVISI":
                    document.getElementById("revisi_pil").value = "ACC";
                    button.value = "ACC";

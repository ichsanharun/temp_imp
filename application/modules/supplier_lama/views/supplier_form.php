<div class="nav-tabs-supplier">
    ...
    $type = 'edit';
                ...
                <div class="form-group ">
                    ...
                    <label for="id_webchat" class="col-sm-2 control-label">CBM</label>
                    <div class="col-sm-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
                        <input type="text" style="text-transform:uppercase" class="form-control" id="cbm" name="cbm" maxlength="4" placeholder="CBM" value="<?php echo set_value('cbm', isset($data->cbm) ? $data->cbm : ''); ?>">
                        </div>
                    </div>                    
                </div>

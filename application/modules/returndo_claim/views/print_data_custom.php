...
<body style=<?php echo '"font-size: '.$uk1.'pt !important;"';?>>
    ...
    <table width="100%" id="tabel-laporan" style=<?php echo '"font-size: '.$ukkk.'px !important;font-weight:bold;padding-top:7px !important"';?>>
        <tr>
            ...
            <th width="">NILAI UANG KEMBALI</th>
            <th width="">#</th>
            <th width="">NAMA KOLI</th>
            <th width="">QTY KOLI</th>
            <th width="">KOLI TOTAL</th>
        ...
        <tr>
            ...
            <td rowspan="<?php echo $rs?>"><center><?php echo $vd->nm_barang?></center></td>
            <td rowspan="<?php echo $rs?>"><center><?php echo $vd->ganti+$vd->qty_uang?></center></td>
            <td rowspan="<?php echo $rs?>"><center><?php echo $vd->ganti?></center></td>
            <td rowspan="<?php echo $rs?>"><center><?php echo $vd->qty_uang?></center></td>
            <td rowspan="<?php echo $rs?>"><center><?php echo $vd->uang?></center></td>
            ...
            ?>
                ...
                <td><center><?php echo $vc->qty*$vd->ganti?></center></td>
                <?php if ($ncl == 1) {
                  echo "<td rowspan=".$rs.">".formatnomor(($vd->ganti*$vd->harga_landed)+($vd->qty_uang*$vd->uang))."</td>";
                } ?>

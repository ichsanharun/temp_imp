...
class Hutang extends Admin_Controller
{
    ...
    {
        $pi = $this->db->query('SELECT a.id as idsss, a.status as st, a.*, b.*  FROM `trans_po_payment` as a, trans_po_header as b WHERE a.no_po=b.no_po ');
    ...
    public function add_ajax_prodi($id_fak)
    {
        ...
        foreach ($query->result() as $value) {
            $data .= "<option value='".$value->no_perkiraan."'>".$value->nama.'</option>';
        }
        echo $data;
    }

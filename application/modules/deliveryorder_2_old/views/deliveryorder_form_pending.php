                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" style="padding-top: 8px;">
                                ...
                                <input type="hidden" name="status_do" value="DO-PENDING">
        ...
        <table id="deliveryorderitem" class="table table-bordered table-striped" width="100%">
            <thead>
                <tr>
                    ...
                    <th>Item Barang</th>
                    <th>Satuan</th>
                    <th width="15%" class="text-center">Qty Confirm<br>Pending</th>
                    <th width="15%" class="text-center">Qty Supply<br>Pending</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        <center>
                        <?php echo $vdo->no_so_pending?>
                        <input type="hidden" name="noso_todo_pending[]" value="<?php echo $vdo->no_so_pending?>">
                        </center>
                    </td>
                    <td>
                    ...
                    <td>
                        <center><input type="text" name="qty_confirm[]" id="qty_confirm_<?php echo $no?>" class="form-control input-sm" value="<?php echo $vdo->qty_confirm?>" readonly></center>
                    </td>
                    <td>
                        <center><input type="text" name="qty_supply[]" id="qty_supply_<?php echo $no?>" class="form-control input-sm" onkeyup="cekqtysupply('<?php echo $no?>')"></center>
                    </td>
                </tr>
                <?php } ?>
                <?php } ?>
...
<script type="text/javascript">
   ...
   var kendaraan		=<?php echo json_encode($kendaraan);?>;
    ...
    function cekqtysupply(no){
        var confirm = parseInt($('#qty_confirm_'+no).val());

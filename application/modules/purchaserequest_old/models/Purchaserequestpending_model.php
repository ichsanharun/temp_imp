 ...
 *
 * This is model class for table "trans_pr_pending_header"
 */

class Purchaserequestpending_model extends BF_Model
{

    /**
     * @var string  User Table Name
     */
    protected $table_name = 'trans_pr_pending_header';
    protected $key        = 'no_pr_pending';

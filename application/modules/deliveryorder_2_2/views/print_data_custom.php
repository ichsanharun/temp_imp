...
<body style=<?php echo '"font-size: '.$uk1.'pt !important;"';?>>
    ...
    <table width="100%" id="tabel-laporan" style=<?php echo '"font-size: '.$ukkk.'px !important;padding-top:0px !important;font-family: Arial, Helvetica, sans-serif !important;"';?>>
        <tr>
            <th width="2%">NO</th>

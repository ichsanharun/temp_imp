...
<?php
$uk1 = $this->uri->segment(4);
$ukk = $this->uri->segment(5);
$ukkk = $this->uri->segment(6);
?>
<body style=<?php echo '"font-size: '.$uk1.'pt !important;"';?>>
    ...
    <table width="100%" id="tabel-laporan" style=<?php echo '"font-size: '.$ukkk.'px !important;font-weight:bold;padding-top:7px !important"';?>>
        ...
        foreach(@$detail as $kd=>$vd){
            ...
            $rs = $this->db->query("SELECT * FROM barang_koli WHERE id_barang ='".$vd->id_barang."'")->num_rows()+1;
            $rs1 = count($colly);
        ?>
        <tr>
            <td rowspan="<?php echo $rs?>"><center><?php echo $no.$rs?></center></td>

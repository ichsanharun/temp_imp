...
class Barang_packing extends Admin_Controller {
     ...
     */
    //Permission
    protected $viewPermission   = "Barang_packing.View";
    protected $addPermission    = "Barang_packing.Add";
    protected $managePermission = "Barang_packing.Manage";
    protected $deletePermission = "Barang_packing.Delete";
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Barang_packing/Barang_model',
                                 'Barang_stock/Barang_stock_model',
                                 'Barang_group/Barang_group_model',
                                 'Barang_packing/Barang_jenis_model',
                                 'Barang_packing/Barang_cp_model',
    ...
    public function index()
    {
     ...
     $component = $this->Barang_stock_model
                ...
                ->where(array('barang_stock.deleted'=>0,'barang_stock.kategori'=>'component'))
                ->order_by('barang_stock.nm_barang','ASC')->find_all();
        $this->template->set('results', $data);
        $this->template->set('colly', $colly);
    ...
    function saveunpacking(){
        ...
        $dataunpacking = array(
            ...
            'qty_stock'=>$qty_unpacking,
            'qty_avl'=>$qty_unpacking,
      ...
      endforeach;
   	...
   	public function edit()
   	{
        ...
        $data = $this->Barang_stock_model->select("barang_stock.*,
                                              ...
                                              barang_group.nm_group,
                                              barang_stock.satuan AS setpcs,
                                              barang_stock.harga AS harga_stock,
                                              supplier.nm_supplier,
                                              barang_master.qty as qty")
                                              ->join("barang_master","barang_stock.id_barang = barang_master.id_barang","left")
                                              ->join("barang_group","barang_group.id_group = barang_master.id_group","left")
           ...
           $this->template->title('Unpacking Produk Set');
        $this->template->render('unpacking_form');
   	}
    ...
    public function save_data_ajax(){
        ...
        if(empty($id_barang) || $id_barang==""){
            $param = $id_jenis.$id_group.$id_supplier;
            $query = $this->Barang_model->get_kode_barang($param,$id_group,$id_supplier);
            if(empty($query)){
                return 'Error';
            }else{
                $id_barang=$query;

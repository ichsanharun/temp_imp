                ...
                <div class="box-body">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="cabang_asal" class="col-sm-4 control-label">Cabang </font></label>
                        ...
                        <div class="form-group ">
                            <label for="cabang_tujuan" class="col-sm-4 control-label">Permintaan Ke Cabang<font size="4" color="red"><B>*</B></font></label>
                            <div class="col-sm-8" style="padding-top: 8px;">
								<?php
...
<div class="box box-default ">
	<div class="box-header">
		<h4 class="box-title">Detail Item PO</h4>

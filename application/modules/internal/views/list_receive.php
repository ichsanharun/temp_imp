                    ...
                    <div class="box-body">
                          ...
                          <div class="col-sm-6">
                              ...
                              <div class="form-group ">
                                ...
                                <div class="col-sm-8" style="padding-top: 8px;">
                  								<?php
                  								echo"<input type='text' name='tgl_receive' id='tgl_receive' class='form-control input-sm datepicker' value='".date('Y-m-d')."'>";
                  								?>
        ...
        <th width="15%"><center>QTY RECEIVE</center></th>
			...
			<?php
				...
				foreach(@$detail as $krm=>$vrm){
					$no=$n++;
          $ambil_so = $this->db->where(array('keterangan'=>$vrm->no_mutasi,'MID(trans_so_header.no_so,5,3)'=>'SOI','id_barang'=>$vrm->id_barang))->join('trans_so_detail','trans_so_detail.no_so = trans_so_header.no_so', 'left')->get('trans_so_header')->row();
			?>
			<tr>
				...
				<td>
				<input type="text"  name="data[<?php echo $no ?>][qty_receive]" id="qty_receive_<?php echo $no?>" style="text-align: right;" class="form-control input-sm amount" value="">

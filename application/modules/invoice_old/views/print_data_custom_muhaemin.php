...
<body>
    ...
    $total_nominal = @$header->hargajualafterdis-@$header->diskon_toko_rp-@$header->diskon_cash_rp;
    $diskon_stdr_persen = '-';
    $diskon_stdr_rp = 0;
    $diskon_toko_persen = '-';
    $diskon_toko_rp = 0;
    $diskon_cash_persen = '-';
    $grand_total_view = $total_nominal;
    //$diskon_stdr   = @$header->
    if(@$set_custom != ""){
        ...
        $diskon_cash_rp = @$header->diskon_cash_rp;
        $grand_total_view = @$header->hargajualbefdis-$diskon_stdr_rp-$diskon_toko_rp-$diskon_cash_rp;
    }
    ?>
<htmlpagefooter name="footer">
    ...
    <table width="100%" border="0">
        ...
        <tr>
            ...
            <td width="1%">:</td>
            <td width="15%" style="text-align: right;"><?php echo formatnomor($diskon_cash_rp)?></td>
            <!--<td width="10%"></td>-->
        </tr>
        <tr>
            <td colspan="3"></td>

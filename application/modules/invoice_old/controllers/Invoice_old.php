			...
			*/
			...
			if($OK==1){
				...
				foreach($DO_Detail as $keys=>$values){
					...
					$rp_diskon_so		= $harga_so*$diskon_persen_stdr/100;
					$harga_so_diskon	= $harga_so-$rp_diskon_so;
					...
					*/
					...
					$Arr_detail[$Awal]['harga_after_diskon_stdr']	= $harga_so_diskon;
				...
				$Diskon_Toko_Rp 		= $Total_After*$Diskon_Toko/100;
				$Total_After_Bersih		= $Total_After-$Diskon_Toko_Rp;

				$Grand_Total			= $Total_After_Bersih + $PPN + $Biaya_Materai;
				...
				$headerinv = array(
					...
					'diskon_cash_rp'    => 0, //Default 0 karena berubah jika SO diedit karena Bayar Cash
					'hargajualbefdis'	=> $Total_DPP,//total sebelum diskon standar 30%
					'hargajualafterdis'	=> $Total_After,//total setelah diskon standar 30%
					'hargajualafterdistoko'	=> $Total_After_Bersih,//total setelah diskon
					'hargajualafterdiscash'	=> 0,//Default 0 karena berubah jika SO diedit karena Bayar Cash
				...
				//echo"<pre> DETAIL INV :<br> ";print_r($Arr_detail);echo "HEADER INV :<br>";print_r($headerinv);echo "DATA AR :<br>";print_r($dataAR);exit;

...
<body>
    <p style="text-align:center; font-weight:bold; padding-top:5mm;">DATA ADJUSMENT STOK</p>
    <br>
    <table style="tr:hover {border-right: 0px #f5f5f5;}" align="center">
        <tr>
            <td style="width:50mm;">Kode Set</td>
            <td style="width:60mm;" colspan="2"><b><?=$brg_data->id_adjusment;?></b></td>                  
        </tr>
        ...
        <tr>
            <td><b>Qty Stock</b></td>
            <td><b>Jenis Adjusment</b></td>
            <td><b>Nilai Adjusment</b></td>                    
        </tr>
        <tr>
            <td><?=$brg_data->qty;?></td>
            <td><?=$brg_data->tipe_adjusment;?></td>
            <td><?=number_format($brg_data->nilai_barang);?></td>                    
        </tr>>       
    </table>

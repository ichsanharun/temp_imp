        ...
        <table id="podetailtoreceiving" class="table table-bordered table-striped" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><center>
                        <?php echo $vp->qty_po-$vp->qty_acc?>
                        <input type="hidden" name="qty_po[]" id="qty_po" value="<?php echo $vp->qty_po-$vp->qty_acc?>"/>
                        <input type="hidden" name="no_po[]" id="no_po" value="<?php echo $vp->no_po?>"/>
                    </center></td>
                    <td width="10%">
                        <center>
                    ...
                    <td>
                        <input style="width: 40%;" type="text" name="qty_broken[]" id="qty_broken" value="0" class="form-control input-sm">
                    </td>
                </tr>
                <?php } ?>
            </tbody>

            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" id="qtyconfirm_<?php echo $no?>" value="<?php echo $vdo->qty_pr-$vdo->qty_po?>" name="qty_pr[]" class="qtyconfirm">
      ...
      $('#harga_total').val($('#harga_total').val().replace(/[^\d]/g,""));
        ...
        function(isConfirm){
          if(isConfirm) {
            ...
            $.ajax({
                url: siteurl+"purchaseorder/saveheaderponeww",
                dataType : "json",
                type: 'POST',
                data: formdata,

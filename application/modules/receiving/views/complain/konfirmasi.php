            ...
            foreach ($barang->result() as $row_bar)
            {
                ...
                foreach ($query_koli->result() as $row_koli)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <input readonly="" class="form-control input-sm" name="rusak[]" value="<?= $row_koli->rusak ?>" />
                        </td>
                        <td>
                            <input class="form-control input-sm" name="complain[]" value="<?= $row_koli->rusak ?>" />
                        </td>
                    </tr>
                    <?php
                }
...
<script>
    function saveheaderpr(){
               ...
               // console.log(formdata);
                $.ajax({
                    url: siteurl+"receiving/receiving_complain/konfrimasi_save",
                    dataType : "json",
                    type: 'POST',
                    data: formdata,
                    success: function(result){
                        ...
                        if(result.save=='1'){
                            ...
                            setTimeout(function(){
                                window.location.href=siteurl+'receiving/receiving_complain/pusat';
                            },1600);
                        } else {
                            swal({
                                title: "Gagal!",

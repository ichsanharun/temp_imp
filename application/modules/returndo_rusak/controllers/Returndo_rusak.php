...
class Returndo_rusak extends Admin_Controller {
    ...
    */
    ...
    public function index()
    {
        ...
        $data = $this->Deliveryorder_model->order_by('no_do','ASC')->find_all_by(array('konfirm_do' => 'SUDAH'));

        $this->template->set('results', $data);
        $this->template->title('Return DO Barang Rusak');

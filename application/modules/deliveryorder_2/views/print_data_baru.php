...
<body style=<?php echo '"font-size: '.$uk1.'pt !important;"';?>>
    ...
    <table  id="tabel-laporan" style=<?php echo '"font-size: '.$ukkk.'px !important;font-weight:bold;padding-top:7px !important;margin-right:30%"';?>>
        <tr>
            <th width="2%">NO</th>
        ...
        <tr>
            ...
            <td rowspan="<?php echo $rs?>" nowrap><?php echo $vd->nm_barang?></td>

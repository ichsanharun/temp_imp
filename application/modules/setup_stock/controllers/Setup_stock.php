 ...
 * 
 * This is controller for Setup_stock
 */

class Setup_stock extends Admin_Controller {
     ...
     */
    //Permission
    protected $viewPermission   = "Setup_stock.View";
    protected $addPermission    = "Setup_stock.Add";
    protected $managePermission = "Setup_stock.Manage";
    protected $deletePermission = "Setup_stock.Delete";
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Barang/Barang_model',
                                 'Setup_stock/Setup_stock_model',
                                 'Aktifitas/aktifitas_model'
                                ));
        
        date_default_timezone_set("Asia/Bangkok");

        $this->template->title('Setup Stock');
    ...
    public function index()
    {
        ...
        $data = $this->Setup_stock_model->find_all_by( array('kdcab'=>$this->auth->user_cab(), 'deleted'=>0) );        
    ...
    public function save_data_ajax(){
        ...
        else //Add New
        {
            ...
            //Add Data
            $id = $this->Setup_stock_model->insert($data);
    ...
    function hapus_barang()
    {
        ...
        if($id!=''){
            ...
            $result = $this->Setup_stock_model->delete_where($wheres);
    ...
    function print_request($id){
        ...
        $brg_data      =  $this->Setup_stock_model->find_by( array('kdcab'=>$this->auth->user_cab(), 'id_barang'=>$id_barang) );
    ...
    function print_rekap(){       
        ...
        $stok_data = $this->Setup_stock_model->find_all_by( array('kdcab'=>$this->auth->user_cab(), 'deleted'=>0) ); 

        ...
        $pn = $grand-$dpp;
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2" class="text-right"><b><?php echo formatnomor($dpp_sebelum_toko)?></b></td>
                </tr>
                <tr>
                    <th colspan="8" class="text-right">Diskon Toko (<?php echo formatnomor($headerso->persen_diskon_toko)?>%): </th>
                    <th colspan="2" class="text-right"><b><?php echo formatnomor($dt)?>-</b></th>
                    <th></th>
                </tr>
                <tr>
                    <th colspan="8" class="text-right">Diskon Cash (<?php echo formatnomor($headerso->persen_diskon_cash)?>%): </th>
                    <th colspan="2" class="text-right" style="border-bottom:solid 2px #000"><b><?php echo formatnomor($dc)?>-</b></th>
                    <th></th>
                </tr>
                <tr>

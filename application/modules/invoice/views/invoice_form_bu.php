                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              <div class="input-group">
                                ...
                                <input type="text" name="tanggal_invoice" id="tgl_inv" class="form-control input-sm datepicker" value="<?php echo $records[0]['detail_data'][0]['tanggal']; ?>">
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-sm-6 form-horizontal">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                              <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="text" name="tgljatuhtempo" id="tgljatuhtempo" class="form-control input-sm datepicker" value="" readonly>
                              </div>
                            </div>
                        </div>
                        <!-- Data Keterangan -->
                        <?php
                        $ckd = $this->db->where(array('no_do'=>$records[0]['detail_data'][0]['no_do']))->get('trans_do_header')->row() ; ?>
                        <div class="form-group ">
                          <label for="keterangan" class="col-sm-4 control-label">Keterangan<font size="4" color="red"><B>*</B></font></label>
                          <div class="col-sm-8">
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-file"></i></span>
                              <textarea name="keterangan" id="keterangan" class="form-control input-sm" placeholder="Keterangan"><?php echo $ckd->nd; ?></textarea>
                            </div>
                          </div>
                        </div>
                        <!-- Data Keterangan -->

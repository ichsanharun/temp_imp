                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    ?>
                                    <input type="radio" value="3" onclick="setdiskoncash(this.value)" name="diskoncash"/>CASH
                                    ...
                                    <?php }else{ ?>
                                    <input type="radio" value="3" onclick="setdiskoncash(this.value)" name="diskoncash" checked="checked"/>CASH
...
<script type="text/javascript">
    ...
    function setdiskoncash(d){
        if(d == 3) {
            $('#nilaidiskoncash').val(3);
            sethitung();
        }else{
            $('#nilaidiskoncash').val(0);
            sethitung();
        }
    }

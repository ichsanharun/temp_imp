...
<div id="wrapper">
    ...
    <table width="100%" id="tabel-laporan">
        ...
        <tr>
            ...
            <td><center><?php echo $vs->satuan?></center></td>
            <td><center><?php echo $vs->qty_order?></center></td>
            <td></td>
            <td style="text-align: right;"><?php echo formatnomor($vs->harga)?></td>
            <td style="text-align: right;"><?php echo formatnomor($vs->harga*$vs->qty_order)?></td>
            <td></td>
        </tr>
        <?php } ?>
    </table>
...
<htmlpagefooter name="footer">
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <td width="20%"><center>Checker</center></td>
            <td width="20%"><center>Disetujui,</center></td>
            <td width="10%">JUMLAH NOMINAL</td>
            <td width="1%">:</td>
            <td width="10%" style="text-align: right;"><?php echo  formatnomor($total)?></td>
        ...
        <tr>
            <td width="15%"><center>( Adm Mkt )</center></td>
            <td width="15%"><center>( Adm & Ka. Gudang )</center></td>
            <td width="15%"><center>( BM / SPV )</center></td>
        ...
        <tr>
            ...
            <td width="1%">:</td>
            <td style="border:solid 1px #000;text-align: right;margin-right: 10px;"><b><?php echo  formatnomor($total)?></b></td>
